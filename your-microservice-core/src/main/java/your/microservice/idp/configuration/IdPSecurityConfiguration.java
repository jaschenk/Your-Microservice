...
public class IdPSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                // Avatar images
                .antMatchers("/api/cms/avatar/app/organization/*/content").permitAll()
                .antMatchers("/api/cms/avatar/app/organization/*/person/*/content").permitAll()
                ...
                .antMatchers("/api/countrystatecodes/**").permitAll()

                //.antMatchers("/api/organization/all").permitAll()
                //api/organization/find is deprecated
                //.antMatchers("/api/organization/find").permitAll()
                //.antMatchers("/api/person/exists").permitAll()

                .antMatchers("/api/account/resetPassword/*").permitAll()
                .antMatchers("/api/account/activateAccount/**").permitAll()
